...
public class sketchpad2 extends Frame {
    class drawObj {
        ...
        public void mouseClicked(MouseEvent e) {
            if (md == 10) {
                ...
                /*if (selected.get(0).mode == 3){
                    ...
                    //System.out.println("Index "+ index +" "+myPic.get(index).st+myPic.get(index+1).st+myPic.get(index+2).st+myPic.get(index+3).st);
                }*/
                dmin = 3;
            }
            if (md == 11){
            ...
            if (md == 12 && selected != null ){
                ...
                myPic.add(new drawObj(selected.get(0).mode, selected.get(0).col, selected.get(0).st,selected.get(0).num, x, y, (selected.get(0).xj+movx), (selected.get(0).yj+movy)));
            }
            repaint();
        }
    }
    ...
    public static void main(String[] s) {
        new sketchpad2().setVisible(true);
    }
}